...
from mse_training.vae_model_new import MolecularVAEMSE, vae_loss_function_mse
...
def main():
    ...
    for epoch in range(start_epoch, EPOCHS + 1):
        ...
        if epoch % 5 == 0:
            checkpoint_path = f'checkpoints_new/vae_model_pairwise_epoch{epoch}_full_model_fixed.pth'
            torch.save({
                'epoch': epoch,
