...
def pairwise_distance_loss(true_coords, pred_coords, p=2):
    """E(3) invariant loss using pairwise distances between atoms."""
...
from mse_training.vae_model_vanilla import MolecularVAEVanilla, vae_loss_function_vanilla
...
def main():
    ...
    for i in range(train_data_np.shape[0]):
        ...
        # Create edge_index using radius_graph with cutoff
    ...
    parser = argparse.ArgumentParser(description='Train Vanilla VAE with MSE loss')
