...
__all__ = ["Scalar", "DipoleMoment", "ElectronicSpatialExtent", "VectorOutput", "EquivariantEncoder"]
...
# equivariant vector output with custom output channels, where the output channels are the latent variables. 
class EquivariantEncoder(OutputModel):
    def __init__(self, hidden_channels, activation="silu", allow_prior_model=True, output_channels = 20):
        super(EquivariantEncoder, self).__init__(allow_prior_model=allow_prior_model)
